...
const test_packages_service_1 = require("./test-packages/test-packages.service");
...
async function bootstrap() {
    ...
    const pkgService = app.get(test_packages_service_1.TestPackagesService);
    ...
    const qService = app.get(questions_service_1.QuestionsService);
